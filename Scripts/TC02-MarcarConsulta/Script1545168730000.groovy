...
WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/div_CURA Healthcare Service'))
...
WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/label_Apply for hospital readm'))

WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/div_Visit Date (Required)_inpu'))

WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/th_'))

WebUI.click(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/td_4'))
...
WebUI.check(findTestObject('Object Repository/MarcarConsulta/Page_CURA Healthcare Service/section_Appointment Confirmati'))
